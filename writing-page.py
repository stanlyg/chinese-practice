...
parser.add_argument("--top-margin",default=0.25,help="Page top margin.")
parser.add_argument("--left-margin",default=0.25, help="Page left margin.")
parser.add_argument("--square-size",default=.7, help="Size of squares for Chinese characters. Font is autoscaled to 8/9 of the box size.")
parser.add_argument("--pinyin-height",default=0.25, help="Height of pinyin text.")
parser.add_argument("--vspace",default=0.1, help="Vertical space between bottom of square and top of pinyin.")
parser.add_argument("--hspace",default=0.15, help="Horizontal space between columns.")
